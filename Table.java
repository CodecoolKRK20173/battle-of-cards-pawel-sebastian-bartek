        ...
        for(int i = 0; i < 10; i++){
            for(int index: indexes){
                ...
                if(i == 0){
                    ...
                    builder.append("|" + card.center("1) MaxSpeed:  " + String.format("%3s", Integer.toString(card.getParameter1()))) + "|" + " ");
                }
                else if(i == 5){
                    builder.append(card.center(line) + " ");
                }
                else if(i == 6){
                    builder.append("|" + card.center("2) HorsePower: " + String.format("%3s", Integer.toString(card.getParameter2()))) + "|" + " ");
                }
                else if(i == 7){
                    builder.append(card.center(line) + " ");
                }
                else if(i == 8){
                    builder.append("|" + card.center("3) OverAll:    " + String.format("%3s", Integer.toString(card.getParameter3()))) + "|" + " ");
                }
                else if(i == 9){
                    builder.append(card.center(line) + " ");
                }
